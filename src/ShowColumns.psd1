...
GUID = '759c4885-0890-4449-9daa-dac88338f114'

# Author of this module
Author = 'Łukasz Patalas'

# Company or vendor of this module
CompanyName = 'Łukasz Patalas'
...
FunctionsToExport = @('Show-ChildItemColumns')

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = @('Show-Columns')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('format', 'columns', 'show', 'display')

        # A URL to the license for this module.
        LicenseUri = 'https://opensource.org/licenses/MIT'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/lpatalas/ShowColumns'
